...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		System.out.println("in ShiroDbRealm.doGetAuthenticationInfo(), useCaptcha="+ useCaptcha);
		if (useCaptcha) {
		...
		System.out.println("in ShiroDbRealm.doGetAuthenticationInfo(), searching using userService");
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		System.out.println("in ShiroDbRealm.doGetAuthorizationInfo()");
		...
		System.out.println("in ShiroDbRealm.doGetAuthorizationInfo(), searching in userRoleService&organizationRoleService");
	...
	private Collection<String> makePermissions(List<UserRole> userRoles, List<OrganizationRole> organizationRoles, ShiroUser shiroUser) {
		System.out.println("in ShiroDbRealm.makePermissions()");
		// 是否启用超级管理员 
		if (activeRoot) {
			// id==1为超级管理员，构造所有权限 
	...
	public static HashPassword encryptPassword(String plainPassword) {
		System.out.println("in ShiroDbRealm.encryptPassword(), plainPassword="+plainPassword);
	...
	public static boolean validatePassword(String plainPassword, String password, String salt) {
		System.out.println("in ShiroDbRealm.validatePassword(), plainPassword="+plainPassword+",password="+password+",salt="+salt);
	...
	public void clearCachedAuthorizationInfo(String principal) {
		System.out.println("in ShiroDbRealm.clearCachedAuthorizationInfo(),principal="+principal);
	...
	public void clearAllCachedAuthorizationInfo() {
		System.out.println("in ShiroDbRealm.clearAllCachedAuthorizationInfo()");
