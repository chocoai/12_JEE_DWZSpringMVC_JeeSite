...
<%-- zTree --%>
<script src="${contextPath}/styles/ztree/js/jquery.ztree.core-3.5.js" type="text/javascript"></script>
<%--
<script src="${contextPath}/styles/ztree/js/jquery.ztree.all-3.5.js" type="text/javascript"></script>
--%>
...
<div id="footer">Copyright &copy; 2012-2013, xxx.com, All Rights Reserve.</div>
</body>
</html>